...
card_data = {
    # raise or fold: BB[0-1], SB[1-2], BTN[2-3], CO[3-4], HJ[4-5], UTG[5-6]
    "AA" : [6, 7], "KK" : [6, 7], "QQ": [6, 7], "JJ": [6, 6],
    "TT" : [6, 6], "99" : [5.6, 5], "88": [5, 4], "77": [5, 3],
    "66" : [5, 3], "55" : [4, 3], "44": [3], "33": [3],
    "22" : [2.6],
    "AKs": [6, 7], "AQs": [6, 7], "AJs": [6, 7], "ATs": [6, 7],
    "A9s": [6, 3], "A8s": [6, 3], "A7s": [5.7, 3], "A6s": [5.7, 3],
    "A5s": [5.8, 3], "A4s": [5.7, 3], "A3s": [5, 3], "A2s": [4.6, 3],
    "KQs": [6, 5], "KJs": [6, 3], "KTs": [6, 3], "K9s": [5.9],
    "K8s": [4], "K7s": [3.6], "K6s": [3.9], "K5s": [3],
    "K4s": [3], "K3s": [3], "K2s": [2.5],
    "QJs": [6, 3], "QTs": [6, 2.6], "Q9s": [4.6], "Q8s": [3.4],
    ...
    "43s": [2], "32s": [2],
    # raise or fold: BB[0-1], SB[1-2], BTN[2-3], CO[3-4], HJ[4-5], UTG[5-6]
    "AKo": [6, 7], "AQo": [6, 7], "AJo": [6, 4], "ATo": [5.5, 3],
    "A9o": [4, 3], "A8o": [3.9, 2.6], "A7o": [3, 3], "A6o": [3, 2.5],
    "A5o": [3, 3], "A4o": [3], "A3o": [2], "A2o": [2],
